...
export const valueDistribution: Endpoint = {
  ...
  schema: {
    ...
    properties: {
      ...
      value_count: {
        type: 'integer',
        description: 'Number of properties analyzed for price distribution.',
      },
      value_sqft_5: {
        type: 'number',
        description: 'Price per square foot at the 5th percentile.',
      },
      value_sqft_25: {
        type: 'number',
        description: 'Price per square foot at the 25th percentile.',
      },
      value_sqft_50: {
        type: 'number',
      ...
      value_sqft_75: {
        type: 'number',
        description: 'Price per square foot at the 75th percentile.',
      },
      value_sqft_95: {
        type: 'number',
        description: 'Price per square foot at the 95th percentile.',
      },
      value_sqft_min: {
        type: 'integer',
      ...
      value_sqft_mean: {
        type: 'number',
        description: 'Mean price per square foot.',
      },
      value_sqft_sd: {
        type: 'number',
        description: 'Price per square foot standard deviation.',
      },
      value_sqft_count: {
        type: 'integer',
        description:
          'Number of properties analyzed for price per square foot distribution.',
      },
    },
  },
};
