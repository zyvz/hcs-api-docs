...
export const compRental: Endpoint = {
  version: 3,
  target: 'comps_rental',
  level: Level.property,
  summary: 'Rental comparables with similarity score',
  description:
    "The comps_rental endpoint returns a list of rental comparables for a given subject property, ordered by HouseCanary's similarity score algorithm, with an option to include additional data for each comparable property.",
  customParams: [
    {
      name: 'min_sim_score',
      in: 'query',
